...
- **Realism gate** - generated motor data is scored against 289 Schedule P private passenger auto reference datasets (143 from the dec2025 vintage plus 146 from sep2011); the shipped preset must land inside the observed bands (`TestDefaultPresetIsRealistic`).
