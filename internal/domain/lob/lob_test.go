...
func TestValidationNamesTheOffendingField(t *testing.T) {
	cases := []struct {
		...
		{"close_lag.third_party_shape", func(l *LineOfBusiness) { l.Claims.CloseLag.ThirdPartyShape = 0 }},
		{"close_lag.third_party_mean_days", func(l *LineOfBusiness) { l.Claims.CloseLag.ThirdPartyMeanDays = 0 }},
